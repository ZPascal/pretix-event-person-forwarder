...
class TestApiCallTheApiSync(TestCase):
    ...
    def test_call_the_api_post_with_json(self, mock_request):
        ...
        result = self.api.call_the_api("/api/v1/orders/", method=RequestsMethods.POST, json_complete=payload)
    ...
    def test_call_the_api_patch_with_json(self, mock_request):
        ...
        result = self.api.call_the_api(
            "/api/v1/orders/ABC/positions/1/", method=RequestsMethods.PATCH, json_complete=payload
        )
    ...
    def test_call_the_api_delete(self, mock_request):
        ...
        result = self.api.call_the_api("/api/v1/orders/ABC/", method=RequestsMethods.DELETE)

        self.assertEqual(result, {})

    def test_call_the_api_invalid_method_post_without_json(self):
        with self.assertRaises(Exception):
            self.api.call_the_api("/api/v1/orders/", method=RequestsMethods.POST)

    def test_call_the_api_invalid_method_patch_without_json(self):
        with self.assertRaises(Exception):
            self.api.call_the_api("/api/v1/orders/ABC/positions/1/", method=RequestsMethods.PATCH)
    ...
    def test_call_the_api_response_with_status_code(self, mock_request):
        ...
        result = self.api.call_the_api("/api/v1/test", response_status_code=True)
    ...
    def test_call_the_api_includes_basic_auth(self, mock_request):
        api_model = APIModel(host="https://example.com/", token="test-token", username="user", password="pass")
        api = Api(api_model)
    ...
    def test_call_the_api_with_custom_headers(self, mock_request):
        api_model = APIModel(host="https://example.com/", token="test-token", headers={"X-Custom": "value"})
        api = Api(api_model)
    ...
    def test_call_the_api_put_with_json(self, mock_request):
        ...
        result = self.api.call_the_api("/api/v1/resource/1/", method=RequestsMethods.PUT, json_complete=payload)

        self.assertEqual(result["updated"], True)

    def test_call_the_api_invalid_method_put_without_json(self):
        with self.assertRaises(Exception):
            self.api.call_the_api("/api/v1/resource/1/", method=RequestsMethods.PUT)
    ...
    def test_call_the_api_invalid_http_method(self, mock_request):
        ...
        with self.assertRaises(Exception):
            self.api.call_the_api("/api/v1/test", method=fake_method)
...
class TestApiHttpClientCreation(TestCase):
    ...
    def test_create_http_client_async(self):
        api_model = APIModel(host="https://example.com/", token="test-token", http2_support=True)
        api = Api(api_model)
    ...
    def test_create_http_client_with_custom_timeout(self):
        api_model = APIModel(host="https://example.com/", token="test-token", timeout=30.0)
        api = Api(api_model)
    ...
    def test_create_http_client_with_custom_ssl_context(self):
        ...
        api_model = APIModel(host="https://example.com/", token="test-token", ssl_context=custom_ssl)
        api = Api(api_model)
